...
1. Proposals
    ...
    |:-:|:-----:|:-------:|-------|-----------|
    | ✓ | 0     | 20m     | [Array find from right](https://github.com/Kingwl/proposal-array-find-from-right) for stage 1 | Wenlu Wang |

1. Longer or open-ended discussions

    | ✓ | timebox | topic | presenter |
    |:-:|:-------:|-------|-----------|
    |   | 30 | Strong type checking (e.g., Type.isType, or old semantics for Object.prototype.toString) | Daniel Ehrenberg |
...
| 2021-12-07 to 2021-12-08 | Remote: PT                     |
